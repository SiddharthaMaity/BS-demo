...
class ShaderScene(ShaderModule):
    ...
    quality: float = field(default=100, converter=lambda x: clamp(float(x), 0, 100))
    ...
    runtime: Seconds = field(default=15.0, converter=float)
    """The longest module duration; overriden by the user; or default length of 15s"""
    ...
    def set_duration(self, override: Seconds=None, *, minimum: Seconds=15) -> Seconds:
